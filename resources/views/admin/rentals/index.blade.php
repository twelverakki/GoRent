                ...
                <tbody class="text-sm">
                    ...
                    <tr onclick="window.location='{{ route('admin.rentals.show', $rental->id) }}'"
                        ...
                        <td class="py-4 text-right pr-4">
                            <div class="w-8 h-8 rounded-full bg-white border border-slate-100 flex items-center justify-center group-hover:bg-rose-500 group-hover:border-rose-500 transition shadow-sm">
