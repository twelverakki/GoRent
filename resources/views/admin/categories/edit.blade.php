    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                ...
                <p class="text-slate-400 text-sm mt-1">Perbarui informasi kategori.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-50">
            ...
            <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-bold text-slate-600 mb-2">Slug</label>
                    <input type="text" value="{{ $category->slug }}" disabled
                        class="w-full px-5 py-3 bg-slate-100 border-none rounded-xl text-slate-400 font-mono text-sm cursor-not-allowed mb-1">
                    <p class="text-xs text-slate-400">*Slug akan otomatis diperbarui jika nama berubah.</p>
                </div>
